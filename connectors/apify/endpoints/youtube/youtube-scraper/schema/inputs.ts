 ...
 * actorDefinition.input) on 2026-09-10 via scripts/apify-scaffold.ts; curated
...
export const zYoutubeScraperBody = z.object({
    ...
    transcriptionAndSubtitle: z.enum([
        "NONE",
        "ALWAYS_SUBTITLES",
    ...
    subtitlesLanguage: z.enum([
        ...
        "Language to download subtitles in.Note: a subtitle-downloading option must be selected in Transcription & subtitles for this to work.",
    ).optional(),
    ...
    isLive: z.boolean().describe("Will apply the Live filter for search")
        .optional(),
    isBought: z.boolean().describe("Will apply the Purchased filter for search")
        .optional(),
    is4K: z.boolean().describe("Will apply the 4K filter for search")
        .optional(),
    is360: z.boolean().describe("Will apply the 360 degrees filter for search")
        .optional(),
    ...
    preferAutoGeneratedSubtitles: z.boolean().describe(
        "If set to true, automatically generated subtitles are preferred to user subtitles. Note: a subtitle language must be selected and a subtitle-downloading option must be selected in Transcription & subtitles for this to work.",
    ).optional(),
});
