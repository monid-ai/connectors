...
Deno.test("apify#facebook-profile-posts-scraper happy: async loop replay (recorded)", async () => {
    // fixture: recorded live, trimmed per the fixture diet (D11)
    const unit = await testSealedUnit("apify#facebook-profile-posts-scraper");
