...
/**
 * axesso_data/amazon-reviews-scraper — actor input schema, scaffolded from the actor's PUBLISHED
 * input schema (GET /v2/acts/axesso_data~amazon-reviews-scraper/builds/default →
